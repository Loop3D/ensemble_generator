...
'''
    ...
    for i in range(use_cores):
        ...
        egen_calc_vox_ens = f'''ef.calc_voxet.ensemble('{path_to_model}', {nx}, {ny}, {nz}, model_from={pool_list[0]}, model_to={pool_list[-1]}, litho={litho}, scalar={scalar}, scalar_grids={scalar_grads})\n'''
